...
$this->params['breadcrumbs'][] = ['label' => $model->topik_bimbingan, 'url' => ['bimbingan-kuliah-view', 'id' => $model->bimbingan_kuliah_id]];
$this->params['breadcrumbs'][] = $this->title;
?>
<div class="form-upload-file">
    <h3>Unggah Dokumen Bukti <?= Html::encode($model->topik_bimbingan) ?></h3>
    ...
    <?php $form = ActiveForm::begin([ 'enableClientValidation' => true,'options' => ['enctype'=>'multipart/form-data']]);?>
      ...
      <div class="modal-footer">
       <?php echo Html::submitButton(Yii::t('app', 'Unggah'), ['class' => 'btn btn-success']) ?>
        <?= Html::a('Kembali', ['bimbingan-kuliah-view', 'id'=>$model->bimbingan_kuliah_id], ['class'=>'btn btn-primary'])?>
      </div>
      <?php ActiveForm::end(); ?>
</div>