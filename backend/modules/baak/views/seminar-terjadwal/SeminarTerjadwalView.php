...
<div class="seminar-terjadwal-view">
 <div class="panel box box-primary">
    ...
    <p>
        <?= Html::a('Perbaharui', ['seminar-terjadwal-edit', 'id' => $model->seminar_terjadwal_id], ['class' => 'btn btn-primary']) ?>
        <?= Html::a('Hapus', ['seminar-terjadwal-del', 'id' => $model->seminar_terjadwal_id], [
            'class' => 'btn btn-danger',
            'data' => [
                'confirm' => 'Apakah Anda yakin ingin menghapus FRK seminar terjadwal Anda?',
                'method' => 'post',
            ],
        ]) ?>
    </p>
...
//            'deleted_by',
    ...
    <div class="panel box box-primary">
        ...
        <?php \yii\widgets\Pjax::begin(); ?>
            <?=Html::beginForm(['process-realisasi-frk', 'id'=>$model->seminar_terjadwal_id],'post');?>
                            ...
                            if ($dokumen['nama_file'] != NULL) {
                                if($model->status == 'Rencana Kerja' || $model->status == 'Approve FRK'){
                                    return Html::a($dokumen['nama_file'], ['seminar-terjadwal-download','id'=>$dokumen['dokumen_bukti_seminar_terjadwal_id']], ['class' => ''])
                                        .'&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;'
                                        .Html::a('Perbaharui Dokumen', ['seminar-terjadwal-edit-dokumen','id'=>$dokumen['seminar_terjadwal_id'], 'id_dokumen'=>$data['header_detail_dokumen_bukti_id']], ['class' => 'btn btn-primary']);
                                }else{
                                    return Html::a($dokumen['nama_file'], ['seminar-terjadwal-download','id'=>$dokumen['dokumen_bukti_seminar_terjadwal_id']], ['class' => '']);
                                }
                            } else {
                                if($model->status == 'Rencana Kerja' || $model->status == 'Approve FRK'){
                                    return Html::a('Unggah Dokumen', ['seminar-terjadwal-upload', 'id'=>$model->seminar_terjadwal_id, 'id_dokumen'=>$data['header_detail_dokumen_bukti_id']], ['class'=>'btn btn-success']);
                                }else{
