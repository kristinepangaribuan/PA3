...
$this->params['breadcrumbs'][] = ['label' => $model->nama_kegiatan, 'url' => ['kegiatan-pengabdian-masyarakat-view', 'id' => $model->kegiatan_pengabdian_masyarakat_id]];
$this->params['breadcrumbs'][] = $this->title;
?>
<div class="form-upload-file">
    <h3>Unggah Dokumen Bukti <?= Html::encode($model->nama_kegiatan) ?></h3>
    ...
    <?php $form = ActiveForm::begin([ 'enableClientValidation' => true,'options' => ['enctype'=>'multipart/form-data']]);?>
          ...
          <div class="row">
              ...
              <div class="col-md-8">
                <?= $form->field($modelDokumenBukti, 'file')->widget(FileInput::classname(), [
                    'options'=>['accept'=>'file/*'],
                    'pluginOptions'=>['allowedFileExtensions'=>['jpg','gif','png', 'pdf', 'docx', 'doc', 'xmls'], 'maxFileSize' => 1024 * 1024 * 3,
                ],])
                ?>
              </div>
          </div>
      ...
      <div class="modal-footer">
       <?php echo Html::submitButton(Yii::t('app', 'Unggah'), ['class' => 'btn btn-success']) ?>
        <?= Html::a('Kembali', ['kegiatan-pengabdian-masyarakat-view', 'id'=>$model->kegiatan_pengabdian_masyarakat_id], ['class'=>'btn btn-primary'])?>
      </div>
      <?php ActiveForm::end(); ?>
</div>
