...
$this->title = 'Request FRK ' . $dosen['nama_dosen'];
        ...
        <div class="col-md-12">
            <?php
                yii\bootstrap\Modal::begin(
                    [
                        'id' =>'modal',
                        'header' => '<h3>Berikan Alasan Penolakan FRK</h3>',
                        'size' => 'modal-lg'
                    ]);
                ...
                <div class="row">
                    <div class="col-sm-4 col-xs-6">
                        <div class="description-block border-right">
                            <span class="description-text"><b>TOTAL SKS FRK Dosen</b></span>
                            <h5 class="description-header"><?=$total_sks?> SKS</h5>
                        </div>
                        <!-- /.description-block -->
                    </div>
                    <?php if($status == 'Pengajuan FRK'){?>
                    <div class="col-sm-4 col-xs-6">
                        <div class="description-block border-right">
                            <span class="description-text">Approve Semua FRK</span>
                            <h5>
                                <?php if($total_sks > 12){?>
                                    <?= Html::a('Approve FRK', ['process-all-frk','id'=>$dosen['dosen_id'], 'status'=>'Approve FRK'], ['class' => 'btn btn-primary',
                                    'data' => [
                                        'confirm' => "Apakah Anda yakin akan meng-approve semua FRK '.$dosen->nama_dosen .' .? karena jumlah sks > 12",
                                        'method' => 'post',
                                    ],
                                ]) ?>
                                <?php }else {?>
                                <?= Html::a('Approve FRK', ['process-all-frk','id'=>$dosen['dosen_id'], 'status'=>'Approve FRK'], ['class' => 'btn btn-primary',
                                    'data' => [
                                        'confirm' => "Apakah Anda yakin akan meng-approve semua FRK '.$dosen->nama_dosen .' .?",
                                        'method' => 'post',
                                    ],
                                ]) ?>
                                <?php } ?>
                    ...
                    <div class="col-sm-4 col-xs-6">
                        <div class="description-block border-right">
                            <span class="description-text">Tolak Semua FRK</span>
                            <h5><?= Html::button('Tolak FRK', ['value'=>  Url::toRoute(['dosen/rejectfrk', 'id'=>$dosen['dosen_id'], 'status'=>'Reject FRK']),'class' => 'btn btn-danger', 'id'=>'modalButton']) ?></h5>
                        </div>
                        <!-- /.description-block -->
                    </div>
                    <?php } ?>
